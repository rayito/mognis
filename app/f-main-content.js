...
<div className='content anchor mb2' id='info-general'>
    <h2>Info general</h2>
    <p>
      Será el <strong className='large-text'>22 de junio</strong> sobre las <strong className='large-text'>17:30</strong>.
    </p>
    <p className='mb2'>
    ...
    <p className='mb1'>
      ¡Ojo! necesitamos un poco de información sobre ustedes. Rellena este cortito formulario para que podamos organizarlo todo lo mejor posible. 
    </p>
